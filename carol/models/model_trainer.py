...
from carol.util.logger import Logger
from carol.util.replay_buffer import BootstrapIterator, TransitionIterator
...
class ModelTrainer:
    ...
    def train(
        ...
        """
        # print(f"num_epochs: {num_epochs}; patience: {patience}; inpro_threshold: {improvement_threshold}; evaluate: {evaluate}; callback: {callback}")
        ...
        for epoch in epoch_iter:
            ...
            if evaluate:
                ...
                # print(f"epoch: {epoch}; eval_score: {eval_score}")
